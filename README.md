...
> Rendered by [lowlighter/metrics](https://github.com/lowlighter/metrics) via GitHub Actions (`.github/workflows/metrics.yml`), self-hosted in this repo so it doesn't depend on the (frequently overloaded) public github-readme-stats/trophy/activity-graph demo instances.
